...
## ADMIN KIT-REDESIGN — Phase 1 (Users) + Phase 2 (content) DONE; Phase 3 (shell) is the NEXT DEV TASK
...
4. **NEXT DEV TASK = ADMIN REDESIGN PHASE 3** (admin shell → kit `page-frame`/`header-menu`) — Phase 2 (all content entities on §54 EntityTable + §50 forms) is DONE & committed on `v2` (`9ceb7a2..78690a7`), plan `docs/superpowers/plans/2026-07-22-admin-phase2-kit.md`. ⚠️ If Phase 2 hasn't been pushed yet, push `v2` first (owner approves). See the "ADMIN KIT-REDESIGN" section above.
